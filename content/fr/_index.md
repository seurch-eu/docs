---
title: Documentation Searpa
type: docs
bookToc: false
---

# Documentation Searpa

**Searpa** est un [métamoteur de recherche](https://fr.wikipedia.org/wiki/M%C3%A9tamoteur) axé sur la vie privée : une requête mélange les meilleurs résultats de plusieurs sources indépendantes en une seule page claire et rapide, sans traçage, sans publicité et sans profilage. Son moteur de recherche est open source, ce qui permet à tout le monde d'auditer son fonctionnement ou de déployer sa propre instance.
...
Searpa ne vous traque pas, n'affiche pas de publicités et ne construit pas de profil. Les clés API des fournisseurs amont restent sur le serveur et ne sont jamais exposées à votre navigateur, et les requêtes sont envoyées aux fournisseurs sans vous identifier.
