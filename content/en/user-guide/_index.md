...
| Page | What it covers |
|------|----------------|
| [Getting started]({{< relref "getting-started" >}}) | Signing in, your first search, the search tabs |
| [Web search]({{< relref "web-search" >}}) | Engines, result blending, time filters, corrections |
| [Search tabs]({{< relref "search-tabs" >}}) | Images, News, Videos, Maps and Translate |
| [Instant answers]({{< relref "instant-answers" >}}) | Maths, conversions, weather, tools answered inline |
| [Knowledge cards]({{< relref "knowledge-cards" >}}) | Wikipedia, film/TV, places and Q&A side panels |
